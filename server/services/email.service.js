...
class EmailService {
    ...
    async sendContactSubmission(senderName, senderEmail, message) {
    ...
    async sendNewUserWelcomeEmail(userEmail, userName) {
...
This is an automated alert from your Nura AI application.
    ...
    async sendEmail(subject, text, recipient // Make recipient optional or required based on needs
    ) {
        if (!recipient) {
