...
// Configure security headers - REMOVE HELMET CALL WITH SPECIFIC DIRECTIVES
// app.use(helmet({
...
// Apply other security middleware if needed (example using imported config)
// import securityConfig from './middleware/security';
// app.use(securityConfig.securityHeaders); 
// app.use(securityConfig.rateLimiter); // Example - already applied elsewhere?

// Configure rate limiting with higher limits for production
const limiter = rateLimit({
  windowMs: 15 * 60 * 1000, // 15 minutes
  max: process.env.NODE_ENV === 'production' ? 1000 : 500, // Increase dev limit from 100 to 500
